...
```mermaid
flowchart TD
    subgraph CHANNELS["Organic Seeding Channels"]
        C1["Homeschool Facebook Groups & Co-ops"]
        C2["Reddit Communities (r/homeschool, r/ECEProfessionals, r/Parenting)"]
        C3["Teacher Hubs (Pre-K / Kindergarten Circle Time)"]
        C4["Instagram / Pinterest Educational Carousels"]
    end

    subgraph OFFERS["Value-First Entry Points"]
        O1["Free 19-Track Album Link (/listen)"]
        O2["Printable Sound-Before-Symbol Phonics Guide"]
        O3["16-Minute Daily Morning Routine Checklist"]
    end

    subgraph ENGINE["The Sound of Essentials Funnel"]
        E1["Gate 1: /listen (Email Opt-in + Web Player)"]
        E2["5-Day Cultural Delta Email Nurture"]
        E3["Gate 2: $21 Rhythm Ready Workbook / $55 Dictionary"]
    end

    CHANNELS --> OFFERS --> ENGINE
```
